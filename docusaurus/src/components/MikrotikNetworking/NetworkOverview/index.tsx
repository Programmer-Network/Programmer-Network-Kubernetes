    ...
    <div>
      <div className="flex flex-col items-center space-y-4">
        ...
        <DiagramBox>
          ...
          <p className="!mb-0">High-Speed Layer 2 Switching</p>
        </DiagramBox>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="flex flex-col items-center">
            ...
            <DiagramBox className="w-full hover:border-red-500">
              ...
              <p className="!mb-0">(RPis, Mini PCs)</p>
            </DiagramBox>
          </div>
          <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <DiagramBox className="w-full hover:border-orange-500">
              ...
              <p className="text-blue-400 !mb-0">SSID: Home (VLAN 10)</p>
              <p className="text-orange-400 !mb-0">SSID: Guest (VLAN 99)</p>
            </DiagramBox>
          </div>
        </div>
      </div>
