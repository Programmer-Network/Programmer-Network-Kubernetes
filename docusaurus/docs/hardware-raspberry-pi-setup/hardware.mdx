...
While all the hardware is listed below, you can also get the full breakdown by opening the [excel sheet](https://docs.google.com/spreadsheets/d/17sQfTlpE3TCcj2Gz2uwkA2mW_AVzyXSE4EnZitLnAEY/edit?gid=0#gid=0).
...
**[upHere Case Fan 120 mm](https://www.amazon.de/dp/B081SYD24Z?ref=ppx_yo2ov_dt_b_fed_asin_title&th=1)**: High-performance exhaust fans with adjustable speed and metal grill protection, used to efficiently remove heat from the rack and maintain optimal airflow for all components.
